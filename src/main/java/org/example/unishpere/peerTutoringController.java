...
public class peerTutoringController {
    @FXML
    private Circle sendRequest;
    @FXML
    private Circle viewRequests;
    @FXML
...
//    private Button openFormButton;
    ...
    @FXML
    public void openFormPopup(ActionEvent event) {
        try {
            // Load the FXML file for the popup content
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("tutoringForm.fxml")); // Update path as needed
            AnchorPane popupContent = fxmlLoader.load();
            ...
            Stage parentStage = (Stage) openFormButton.getScene().getWindow();
    ...
    @FXML
    public void goToTutorRequestPage(ActionEvent event) throws IOException
    {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("showTutoringRequests.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
